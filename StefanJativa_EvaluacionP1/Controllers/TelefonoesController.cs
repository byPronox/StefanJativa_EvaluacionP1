...
namespace StefanJativa_EvaluacionP1.Controllers
{
    public class TelefonoesController : Controller
    {
        ...
        public TelefonoesController(StefanJativa_EvaluacionP1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Año,Precio")] Telefono telefono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Año,Precio")] Telefono telefono)
        {
            if (id != telefono.Id)
            {
                return NotFound();
